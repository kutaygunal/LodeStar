...
| G | Real Qt UI | A7 install Qt, enable LODESTAR_BUILD_UI=ON, wire the 4 views (matrix/graph/impact/coverage) to the service | Med | DONE | senior-engineer-wpg | PASS (0 failures) | <hash> |
