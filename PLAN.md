...
| D | Coverage + evidence | A5 coverage by verification method; A6 DO-178C evidence package export (matrix+coverage+validation+audit bundle) | Med | DONE | senior-engineer-wpd | PASS (0 failures) | <hash> |
